...
{
    public class GetInvoiceItemQueryHandlerTests : TestBase
    {
        [Fact]
        public async Task Get_should_return_object_if_object_exists()
        {
            ...
            var query = new GetInvoiceItemQuery { ItemId = invoiceItem.ItemId };
            var handler = new GetInvoiceItemQueryHandler(DbContext);
        ...
        public async Task Get_should_return_null_if_object_does_not_exist()
        {
            ...
            var query = new GetInvoiceItemQuery { ItemId = 999 };
            var handler = new GetInvoiceItemQueryHandler(DbContext);
