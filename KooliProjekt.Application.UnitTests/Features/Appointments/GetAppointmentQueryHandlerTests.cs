...
{
    public class GetAppointmentQueryHandlerTests : TestBase
    {
        [Fact]
        public async Task Get_should_return_object_if_object_exists()
        {
            ...
            var query = new GetAppointmentQuery { AppointmentId = appointment.AppointmentId };
        ...
        public async Task Get_should_return_null_if_object_does_not_exist()
        {
            ...
            var query = new GetAppointmentQuery { AppointmentId = 999 };
            var handler = new GetAppointmentQueryHandler(DbContext);
